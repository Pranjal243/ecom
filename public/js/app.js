...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProb = status.dataset.status;
    ...
    if (dataProb === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatteAt).format('hh:mm: A');
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51J6JfxSFTAFOdY8x2jZ6mLLiePt19MEHsUAY3sjL7GuBHdynU3qBWgyhLwSuL67gMFzaaYAR5yntprGbHwcW8Frr00PzGcaEMK');

          case 2:
            stripe = _context2.sent;
            card = null; // card = elements.create('card', {style, hidePostalCode:true})
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkecom"] = self["webpackChunkecom"] || [];
