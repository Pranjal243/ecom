...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProb === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatteAt).format('hh:mm: A , D/M/yyyy');
